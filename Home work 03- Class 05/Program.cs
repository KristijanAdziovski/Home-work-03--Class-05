using Home_work_03__Class_05.Method;
using System;

namespace Home_work_03__Class_05
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                while (flag)
                {
                    Console.WriteLine("Choose car brand and drivers !");
                    Driver[] drivers =
                    {
                        new Driver("Bob",5),
                        new Driver("Gred",4),
        ...
        private static void GetDriversAndCars(Driver[] drivers, Car[] cars)
        {
